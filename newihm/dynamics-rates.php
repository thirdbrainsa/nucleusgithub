...
require_once 'twitter-php-master/src/twitter.class.php';
	$message2="#".$instrument_max." is bullish with ".$max_diff."% during last hour while  #".$instrument_min." is bearish with a ".$min_diff."% , see www.thirdbrainfx.com #forex #market #finance";
	echo $message2;						
				if ($_MODE_TWITTER==1)
				{
