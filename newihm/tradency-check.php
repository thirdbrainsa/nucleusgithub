...
$SQL="select instrument,strategy,whenopen,profit,count,dayprofit,drawdown,winningperc,awt,alt,tbx_score from ranking_week order by tbx_score desc,profit desc";
$R=mysql_query($SQL);
echo mysql_error();
