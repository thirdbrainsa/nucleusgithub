...
echo"<div id='currencyihmtrading'>";
if ($change==0)
{
echo "<div id='".$value."'><b>".$value."</b><br><div id='price_".$value."'>".$ask."/".$bid."</div><div onClick=\"javascript:getInfoPairs('".$value."')\"> +  </div></div>";
}
if ($change==1)
{
echo "<div id='".$value."'><b>".$value."</b><br><div id='price_".$value."'><b>".$ask."</b>/".$bid."</div><div onClick=\"javascript:getInfoPairs('".$value."')\"> +  </div></div>";
}
if ($change==2)
{
echo "<div id='".$value."'><b>".$value."</b><br><div id='price_".$value."'>".$ask."/<b>".$bid."</b></div><div onClick=\"javascript:getInfoPairs('".$value."')\"> +  </div></div>";
}
echo"</div>";
?>
<script>
