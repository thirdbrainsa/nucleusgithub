...
if ($message=="")
 ...
 {
 //<a href='login-demo-dashboard.php' class='large green button'><i class=\'fa fa-unlock\'></i> CONNECT TRADING ACCOUNT</a>
 $message="<a href='login-demo-dashboard-partner.php?partner=".$_GET['partner']."' class='large green button'><i class=\'fa fa-unlock\'></i> CONNECT TRADING ACCOUNT</a> <a href='portfolio-management.php' class='large green button'><i class=\'fa fa-bar-chart\'></i> PERFORMANCES</a> <a href='registration/register.php?partner=".$_GET['partner']."' class='large green button'><i class=\'fa fa-desktop\'></i> OPEN DEMO</a><a href='http://smithbrolo.com/1/bolsa-de-valores/' class='large green button' target=_blank><i class=\'fa fa-share-square-o\'></i> OPEN LIVE </a>"; 
 }
 else
 {
...
<tr>
<td align=center>
<div class="AW-Form-919780780"></div>
<script type="text/javascript">(function(d, s, id) {
    var js, fjs = d.getElementsByTagName(s)[0];
    if (d.getElementById(id)) return;
    js = d.createElement(s); js.id = id;
    js.src = "//forms.aweber.com/form/80/919780780.js";
    fjs.parentNode.insertBefore(js, fjs);
    }(document, "script", "aweber-wjs-pfuqypt2j"));
</script>
</td>
</tr>
  <tr>
...
<caption><h1> Available with FXCM </h1></caption>
<tr>
<td>
<a href='http://www.thirdbrainfx.com/access-our-vip-unique-forex-strategies' target=_new><img src='img/fxcm.JPG' style="vertical-align:middle"></a>
</td>
<td valign=middle align=justify>
Do you use FXCM (or FXDD) with the Mirror Trader ? Or do you have an FXCM account live ready ? Or are you about to open one with FXCM ? Our exclusive strategies can be delivered to your FXCM account and synchronized with your TradeStation and/or Metatrader Platform.  You can check performances by clicking on <a href='http://www.thirdbrainfx.com/performances' > this button - FXCM's Premium zone performance </a> and check the conditions to access it by clicking on <a href='http://www.thirdbrainfx.com/access-our-vip-unique-forex-strategies'>Check the conditions to access to the VIP zone of FXCM with THirdBrainFx</a> 
</td>
</tr>
</table>
</td>
