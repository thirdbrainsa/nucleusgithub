  ...
  <head>
   ...
   <link rel="stylesheet" href="../css/tableTrade.css">
    ...
    <script src="js/jquery.min.js" type="text/javascript"></script>
      <script type="text/javascript" src="js/xAPI-live-2.js?time=<?php echo time() ?>"></script> 
      <link rel="stylesheet" type="text/css" href="cockpit.css">
  </head>

  <body>
<div id='position'><img src='img/ajax-loader.gif'></div>
					...
					try {
						...
						if(response.status == true) {
							...
							if (response.returnData.balance!=undefined)
									...
									localStorage.setItem("EquityC",equity);
									}
