...
var listCurrency = ["CZKCASH","HUNComp","W20","FRA40","ITA40","RUS50","SPA35","SUI20","UK100","AUS200","CHNComp","HKComp","INDIA50","JAP225","KOSP200","BRAComp","MEXComp","US100","US2000","US30","US500","VOLX","EURGBP","AUDNZD","AUDJPY","EURNZD","GBPCAD","CHFJPY","EURAUD","GBPAUD","NZDJPY","NZDCAD","USDSEK","EURNOK","GBPNZD","AUDCAD","EURCAD","CADJPY","CADCHF","USDNOK","AUDCHF","EURSEK","GBPUSD","AUDUSD","EURCHF","USDJPY","EURJPY","NZDUSD","USDCHF","GBPCHF","GBPJPY","USDCAD","EUGBP","EURUSD","EURCZK","USDMXN","USDTRY","USDPLN","USDCZK","GBPPLN","EURRON","USDZAR","CHFHUF","EURHUF","USDRON","USDHUF","EURPLN","USDCLP","CHFPLN","EURTRY"];
...
//var url_matrix="http://pre-prod.nucleus.thirdbrainfx.com/receiver-matrix.php";
 ...
 var url_matrix="http://localhost/basetrade/insert_rates.php";
			...
			for (var i =0 ; i <=listCurrency.length - 1; i++) 
						{
							...
							var timestamp=localStorage.getItem("timestamp_"+nameOfThekeyS);
							if (timestamp=="Infinity") {timestamp=0;}
							if (timestamp=="Infinity") {timestamp=0;}
							buildVariable=buildVariable+"&Ask_"+keyS+"="+get_value_ask+"&Bid_"+keyS+"="+get_value_bid+"&tm_"+keyS+"="+timestamp;
