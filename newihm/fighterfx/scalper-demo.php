  ...
  <head>
   ...
   <link rel="stylesheet" href="../css/tableTrade.css">
    ...
    <script src="js/jquery.min.js" type="text/javascript"></script>
      <script type="text/javascript" src="js/xAPI-scalper.js"></script> 
...
div55.style.visibility = 'hidden';
    ...
    <META http-equiv="refresh" content="90; URL=../fighterfx/scalper-demo.php?start=<?php echo $_REQUEST['start'] ?>">
</body>
</head>
</html>