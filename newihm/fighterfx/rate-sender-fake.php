...
var listCurrency = ["EURGBP","AUDNZD","AUDJPY","EURNZD","GBPCAD","CHFJPY","EURAUD","GBPAUD","NZDJPY","NZDCAD","USDSEK","EURNOK","GBPNZD","AUDCAD","EURCAD","CADJPY","CADCHF","USDNOK","AUDCHF","EURSEK","GBPUSD","AUDUSD","EURCHF","USDJPY","EURJPY","NZDUSD","USDCHF","GBPCHF","GBPJPY","USDCAD","EUGBP","EURUSD","EURCZK","USDMXN","USDTRY","USDPLN","USDCZK","GBPPLN","EURRON","USDZAR","CHFHUF","EURHUF","USDRON","USDHUF","EURPLN","USDCLP","CHFPLN","EURTRY","DE30"];
			...
			for (var i =0 ; i <=listCurrency.length - 1; i++) 
						{
							...
							// BECAREFULL BUILD FAKE VALUE WHEN MARKET IS CLOSED. 
							
							
							if (last_ask==0)
							{
							get_value_ask=parseFloat(get_value_ask)+(Math.random() * 50 +10)* 0.00001-(Math.random() * 50 + 10) * 0.00001;
							get_value_bid=parseFloat(get_value_ask)-(Math.random() * 50 +10)* 0.00001;
							}
							else
							{
							get_value_ask=parseFloat(last_ask[keyS])+(Math.random() * 50 +10)* 0.00001-(Math.random() * 50 + 10) * 0.00001;
							get_value_bid=parseFloat(get_value_ask)-(Math.random() * 50 +10)* 0.00001;
							}
							//
							last_ask[keyS]=get_value_ask;
							//last_bid=get_value_bid;
