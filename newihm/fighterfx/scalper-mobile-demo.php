...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
  <head>
    <meta charset="utf-8">
    <title>STORM TRADER - MOBILE VERSION - THIRDBRAINFX</title>
  ...
  <body>
<?php  
include ('template-scalper-mobile.html');
?>
...
div55.style.visibility = 'hidden';
	...
	login();
	 ...
	 if (localStorage.getItem("stopall")==0)
	 {
	  ...
	  show5();
	   ...
	   document.getElementById("status").innerHTML="<div id='blank'></div>";
    ...
    <META http-equiv="refresh" content="120; URL=../fighterfx/scalper-mobile-demo.php?start=<?php echo $_REQUEST['start'] ?>">
</body>
</head>
</html>