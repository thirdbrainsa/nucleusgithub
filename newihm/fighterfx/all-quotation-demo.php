...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
  ...
  <body>
<?php  
include ('template-quotation-demo.html');
?>
<script type="text/javascript">
...
// Other url for xaPI connection are
 ...
 // Initialize all position, and digits 
    //localStorage.clear();
     ...
     //localStorage.setItem("userID","413417");
     //localStorage.setItem("passwordID","9gFaXkron1UgfoqgkqyTfQ==");
	    ...
	    ws.onmessage = function(evt)
				{
					...
					try {
						...
						console.log('Fatal error while receiving data! :('+Exception.message+')');
					}
				}
