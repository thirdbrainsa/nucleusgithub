...
function closePosition()
{
 ...
 function parseGetAllTrade(returnData) {
				...
				else
				{
					...
					stringPos=stringPos+'<tr><td>'+ii+'</td><td>'+openTimeDate+'</td><td>'+symbol+'</td><td>'+Stype+'</td><td>'+volume+'</td><td>'+openPrice+'</td><td>'+close_price+'</td><td>'+sl+'</td><td>'+tp+'</td><td>'+order2+'</td><td>'+profit+'</td></tr>';
