...
function closePosition()
{
	...
	var arguments = {};
	     arguments.tradeTransInfo = {};
				  ...
				  arguments.tradeTransInfo.volume=parseFloat(lot)/10;
 ...
 function parseGetAllTrade(returnData,ordersearch) {
				...
				else
				{
					...
					if (totalTrade>0)
					{
					var stringPos="<table width=952 cellpadding=0 cellspacing=0 border=0>";
					stringPos=stringPos+'<thead><tr><th>POS</th><th>Open Time</th><th>Symbol</th><th>Command</th><th>Volume</th><th>Open Price</th><th>Price</th><th>SL</th><th>TP</th><th>Order</th><th>Profit</th></tr></thead>';
					...
					var spread=returnData[i].spread;
					...
					stringPos=stringPos+'<tr><td><a href=\"#\" onClick=\"closethis('+order2+');\">'+ii+' [x]</a></td><td>'+openTimeDate+'</td><td>'+symbol+'</td><td>'+Stype+'</td><td>'+volume+'</td><td>'+openPrice+'</td><td>'+close_price+'</td><td>'+sl+'</td><td>'+tp+'</td><td>'+order2+'</td><td>'+profit.toFixed(2)+'</td></tr>';
