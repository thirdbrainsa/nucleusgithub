...
function closePosition()
{
 ...
 function parseGetAllTrade(returnData,ordersearch) {
				...
				else
				{
					...
					stringPos=stringPos+'<thead><tr><th></th><th>POS</th><th>Open Time</th><th>Symbol</th><th>Command</th><th>Volume</th><th>Open Price</th><th>Price</th><th>SL</th><th>TP</th><th>Order</th><th>Com.</th><th>Profit</th></tr></thead>';
					...
					var swap=returnData[i].commission;
					...
					stringPos=stringPos+'<tr><td><a href=\"#\" onClick=\"closethis('+order2+');\">[x]</a></td><td>'+ii+'</td></td><td>'+openTimeDate+'</td><td>'+symbol+'</td><td>'+Stype+'</td><td>'+volume+'</td><td>'+openPrice+'</td><td>'+close_price+'</td><td>'+sl+'</td><td>'+tp+'</td><td>'+order2+'</td><td>'+swap.toFixed(2)+'</td><td>'+profit.toFixed(2)+'</td></tr>';
