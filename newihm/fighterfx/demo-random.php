  ...
  <head>
   ...
   <!--[if lt IE 9]><script src="https://html5shim.googlecode.com/svn/trunk/html5.js"></script><![endif]--> 
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js" type="text/javascript"></script>
      <script type="text/javascript" src="js/xAPI-live-random.js"></script> 
      <link rel="stylesheet" type="text/css" href="cockpit.css">
  </head>

  <body>
<?php  
include ('template6.html');
?>
<script type="text/javascript">
 ...
 var demo_slot="http://178.22.68.239/forexattribute/giveDemoSlot.php";    // Give back an xOpenHub demo slot (need to fill the DB with account with test as password)
	  ...
	  show5();
	   ...
	   // Send info  to webserver 
	    ...
	    //graphicalEA(symbolCurrent);
	     localStorage.setItem("timer",0);
	    window.alert('this demo is ending now...');
           window.location.replace('http://www.thirdbrainfx.com/best-forex-strategies/what-fighterfx-our-tool-scalper-pro');
		}
	    // ---
            } 
