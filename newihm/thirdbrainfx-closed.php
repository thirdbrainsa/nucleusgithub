...
<html>
	<head>
		<title>LAST 42 ORDERS CLOSED BY THIRDBRAINFX ROBO-ADVISORS - CLOSED POSITIONS</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1>Last 42 orders closed by robo-advisors (nucleus)</h1>
		<script>
...
$R="SELECT id,command, instrument,price, sl, tp, profit,strategy,timeinsert,whenopen,signature from historydb ORDER BY timeinsert desc limit 0,48";
$RR=mysql_query($R);
			$pattern="";$i=0;$j=0;
