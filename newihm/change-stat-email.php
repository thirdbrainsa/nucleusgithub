...

{
	...
	if ($login!="")
			{
				$SQL2="select account from alertemail where account='".$login."'";
				$RR2=mysql_query($SQL2);
				list($account)=mysql_fetch_array($RR2);
				if ($account!="")
					{
					
						$SQL3="delete from alertemail where account='".$login."'";
					}
					else
					{
						
						$SQL3="insert into alertemail values ('".$login."','".$password."','".$lot."')";
